...
#'     \item{delta, se_delta}{Pooled standardised difference and its SE.}
...
#' \emph{Psychological Bulletin}, 111(2), 361-365.
#'
#' @examples
...
responder_cles <- function(data,
  ...
  pool <- re_pool(delta, var_delta, conf_level, tau_method)
